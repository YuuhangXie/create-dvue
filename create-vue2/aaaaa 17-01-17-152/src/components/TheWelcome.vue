...
<template>
  <div>
    ...
    <WelcomeItem>
      ...
      <a href="https://cli.vuejs.org/zh/config/#vue-config-js" target="_blank">webpack</a>. The
      recommended IDE setup is <a href="https://code.visualstudio.com/" target="_blank">VSCode</a> +
